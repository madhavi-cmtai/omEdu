...
const Footer = () => {
    return (
        <footer className="bg-[#f7f9fb] text-[#333] pt-16 pb-10 px-6 mt-16 border-t border-gray-200">
            {/* Top Social Section */}
            <div className="max-w-7xl mx-auto text-center mb-10">
                <h3 className="text-xl font-semibold mb-4 text-[#1e293b]">Connect with us</h3>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-sm">
                {/* OM Educom */}
                <div>
                    <h4 className="text-lg font-bold text-[#1e293b] mb-3">OM Educom</h4>
                ...
                {/* Contact Info */}
                <div>
                    <h4 className="text-lg font-bold text-[#1e293b] mb-3">Contact</h4>
                ...
                {/* Navigation */}
                <div>
                    <h4 className="text-lg font-bold text-[#1e293b] mb-3">Navigation</h4>
                ...
                {/* Legal Links */}
                <div>
                    <h4 className="text-lg font-bold text-[#1e293b] mb-3">Legal</h4>
                    <ul className="space-y-2 text-gray-600">
                        <li>
            ...
            <div className="mt-12 text-center text-xs text-gray-500">
                &copy; {new Date().getFullYear()} <span className="font-bold text-blue-600">OM Educom</span> — All rights reserved.
            </div>
        </footer>
    );
};
